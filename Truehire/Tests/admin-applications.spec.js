...
test.describe("TrueHire Admin Applications Page UI Test", () => {
  const adminUser = {
    id: 1,
    name: "TrueHire Admin",
          ...
          applications: [
            {
              ...
              user_name: "Rakshitha R",
              user_email: "rakshitha@example.com",
  ...
  test("Validate filters, dropdowns, date inputs and buttons", async ({ page }) => {
    ...
    await expect(page.getByRole("heading", { level: 3, name: /All Applications/i })).toBeVisible();
