...
- Name: ui\recruiter.spec.js >> Recruiter Module UI >> review applications
- Location: qa\tests\ui\recruiter.spec.js:29:3
...
Locator: getByText(/applications|candidate|status|resume/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/applications|candidate|status|resume/i).first()
