...
- Name: api\admin.api.spec.js >> Admin Dashboard API >> GET /api/admin/dashboard/stats returns dashboard data for admin
- Location: qa\tests\api\admin.api.spec.js:4:3
