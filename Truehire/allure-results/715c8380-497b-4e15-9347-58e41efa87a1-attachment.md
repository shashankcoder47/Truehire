...
- Name: ui\admin.spec.js >> Admin Module UI >> notifications are visible
- Location: qa\tests\ui\admin.spec.js:20:3
...
Call log:
  - waiting for getByRole('link', { name: /notifications/i }).or(getByText(/notifications/i)).first()
