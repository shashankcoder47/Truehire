...
Call log:
  ...
  - waiting for getByText(/welcome|overview|jobs|candidate/i).first()
    - waiting for" http://localhost:3000/login?email=qa.candidate%40truehire.com&password=ChangeMe123%21" navigation to finish...
    - navigated to "http://localhost:3000/login?email=qa.candidate%40truehire.com&password=ChangeMe123%21"
