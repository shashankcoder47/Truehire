...
- Name: ui\admin.spec.js >> Admin Module UI >> reports and analytics are visible
- Location: qa\tests\ui\admin.spec.js:27:3
...
Call log:
  - waiting for getByRole('link', { name: /reports|analytics/i }).or(getByText(/reports|analytics/i)).first()
