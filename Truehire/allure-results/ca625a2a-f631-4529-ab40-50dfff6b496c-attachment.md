...
- Name: ui\candidate.spec.js >> Candidate Module UI >> search job
- Location: qa\tests\ui\candidate.spec.js:8:3
...
Locator: getByText(/Engineer/i).first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText(/Engineer/i).first()
        ...
        - generic [ref=e16]:
          ...
          - generic [ref=e20]:
            - generic [ref=e21]:
              ...
              - generic [ref=e22]:
                - img [ref=e24]
                - textbox "Job Title, Company, or Keywords" [active] [ref=e26]:
          ...
          - generic [ref=e172]:
            - generic [ref=e173]:
              - paragraph [ref=e174]:
                - text: Call Stack
                - generic [ref=e175]: "17"
              - button "Show 14 ignore-listed frame(s)" [ref=e176] [cursor=pointer]:
                - text: Show 14 ignore-listed frame(s)
                - img [ref=e177]
            - generic [ref=e179]:
              - generic [ref=e180]: (pages-dir-browser)/./src/styles/globals.css
              - text: .next\dev\static\chunks\pages\_app.js (158:1)
            - generic [ref=e181]:
              - generic [ref=e182]: eval
              - text: ./src/pages/_app.js
            - generic [ref=e183]:
              - generic [ref=e184]: (pages-dir-browser)/./src/pages/_app.js
