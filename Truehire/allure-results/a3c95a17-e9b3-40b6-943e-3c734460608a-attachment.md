...
- Name: ui\recruiter.spec.js >> Recruiter Module UI >> create job
- Location: qa\tests\ui\recruiter.spec.js:8:3

# Error details

```
Error: Input not found: /title|job title/i

expect(locator).toBeVisible() failed

Locator: getByLabel(/title|job title/i).or(getByPlaceholder(/title|job title/i)).first()
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Input not found: /title|job title/i with timeout 10000ms
  - waiting for getByLabel(/title|job title/i).or(getByPlaceholder(/title|job title/i)).first()
