...
- Name: ui\admin.spec.js >> Admin Module UI >> dashboard validation
- Location: qa\tests\ui\admin.spec.js:7:3
...
Locator: getByText(/dashboard|analytics|users|recruiters/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/dashboard|analytics|users|recruiters/i).first()
