...
export default function Certifications() {
  ...
  return (
    <>
      <Head>
        <title>Certifications - TrueHire</title>
      </Head>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Display your professional certifications and credentials</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 mb-6">
            ...
            <div className="space-y-6">
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-3 text-gray-700">Credential ID: AWS-SAA-123456789</p>
                  </div>
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900">Certified ScrumMaster (CSM)</h3>
                    ...
                    <p className="mt-3 text-gray-700">Credential ID: CSM-987654321</p>
                  </div>
                  <div className="flex space-x-2">
                    <button className="text-gray-400 hover:text-gray-600">
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-blue-600 font-medium">Google Cloud</p>
                    <p className="text-gray-600 text-sm">Issued: June 2023 • Expires: June 2026</p>
                    <p className="mt-3 text-gray-700">Credential ID: GCP-PD-456789123</p>
                  </div>
                  <div className="flex space-x-2">
                    <button className="text-gray-400 hover:text-gray-600">
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
