...
export default function Education() {
  ...
  return (
    <>
      <Head>
        <title>Education - TrueHire</title>
      </Head>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Highlight your academic background and qualifications</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900">Master of Science in Software Engineering</h3>
                    <p className="text-blue-600 font-medium">Tech University</p>
                    <p className="text-gray-600 text-sm">2020 - 2022 • GPA: 3.9/4.0</p>
                    <p className="mt-3 text-gray-700">Focus areas: Machine Learning, Cloud Computing, Advanced Software Development</p>
                  </div>
                  <div className="flex space-x-2">
                    <button className="text-gray-400 hover:text-gray-600">
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">Dean's List</h3>
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">Research Excellence Award</h3>
                    <p className="text-gray-600">Tech University • 2021</p>
                  </div>
                  <div className="flex space-x-2">
                    <button className="text-gray-400 hover:text-gray-600">
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
